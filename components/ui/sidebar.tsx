	...
	return (
		...
		>
			...
			<div
				...
				data-side={side}
				className={cn(
					"fixed inset-x-auto top-[var(--header-height,4rem)] bottom-0 z-30 hidden h-[calc(100vh-var(--header-height,4rem))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
